...
'''BUTTON_LABEL = ['<b style="color:'+black+';">:-(</b>',
                '<b style="color:'+green+';">:-)</b>']'''
				

BUTTON_LABEL = ['<b style="color:'+red+';">Fail</b>',
                '<b style="color:'+darkgreen+';">Pass</b>']
...
if old_addons2delete != '':
    if lang == 'ru':
        ...
        showText(
            ...
            ' <b> &nbsp; • Again Good</b> addon:<pre>' + old_addons2delete +
            '</pre>Please, rename them to add the extension .off, and restart Anki.</big>', type="html")
